                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between w-full max-w-5xl mx-auto">
                        ...
                        <div className="flex justify-center mx-5 lg:mx-0">
                            <div className="flex flex-col mt-7 gap-4  max-w-md px-4 items-center w-full  shadow-2xl py-10 rounded-2xl">
                                ...
                                <button className=" w-full max-w-sm px-5 py-6 mt-7 bg-regal-orange rounded-md text-white font-bold text-xl cursor-pointer">Creeaza un cont</button>
