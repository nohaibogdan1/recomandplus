        ...
        <>
            <div className="flex mt-10 gap-10 md:gap-30 max-w-2xl">
                <div className="hidden md:flex flex-col w-45 gap-10">
                    <div className={`cursor-pointer ${menu === 0 && 'font-medium'}`}
                        onClick={() => setMenu(0)}>Recomandări</div>
                    <div className={`cursor-pointer ${menu === 1 && 'font-medium'}`}
                        onClick={() => setMenu(1)}>Afacere</div>
                    <div className={`cursor-pointer ${menu === 2 && 'font-medium'}`}
                ...
                <div className="flex items-center justify-evenly md:hidden absolute bottom-0 w-45 gap-10 bg-white w-full fixed px-2 z-3">
                    <Link href="/" className="cursor-pointer py-3  items-center flex flex-col  justify-center text-center gap-1 font-light flex-1"
                    >
                        <Image
                            src="/home.svg"
                            alt="Next.js logo"
                    ...
                    <div className="cursor-pointer py-3  items-center flex flex-col  justify-center text-center gap-1 font-light  flex-1"
                        ...
                        <Image
                            ...
                            height={15}
                            priority />
                        <span className={`text-xs text-wrap ${menu === 1 && 'font-medium'}`}>Afacere</span>
                    </div>
                    <div className="cursor-pointer py-3  items-center flex flex-col  justify-center text-center gap-1 font-light flex-1"
                        onClick={() => setMenu(0)}>
                        <Image
                            ...
                            height={15}
                            priority />
                        <span className={`text-xs text-wrap ${menu === 0 && 'font-medium'}`}>Recomandări</span>
                    </div>
                    <div className="cursor-pointer py-3  items-center flex flex-col  justify-center text-center gap-1 font-light  flex-1"
                        onClick={() => setMenu(2)}>
                        <Image
                            ...
                            height={15}
                            priority />
                        <span className={`text-xs text-wrap ${menu === 2 && 'font-medium'}`}>Cont</span>
                    </div>
                </div>
